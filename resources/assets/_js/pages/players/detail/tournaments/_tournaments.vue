                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered mb-5">
                        ...
                        <tr v-for="tournament in tournaments">
                            ...
                            <th class="text-center">{{ getPlace(player, tournament.teams)}}</th>
                        </tr>
                        </tbody>
                    </table>
                </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.getPlayer();
            this.getUserTeamTournaments();
        },
        methods: {
            getUserTeamTournaments()
            {
                ...
                axios.get('/api/users/'+this.$route.params.id+'/tournaments?'+query).then((response) => {
            ...
            getPlace(player, teams)
            {
                ...
                if(teams.length>0)
                {
                    ...
                    {
                        if(player!=null && player.team_id==team.team_id)
                        {
                            place = team.place;
                        }
                    })
