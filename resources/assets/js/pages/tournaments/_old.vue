                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="tabs-1-4">
                        ...
                        <div class="row mt-30">
                            <div class="col-lg-3">
                                <div v-for="team in tournament.teams" v-if="groups[0].teams.indexOf(team.id)>-1" class="team-bracket">
                                    <router-link  :to="{ name: 'team', params: { id: team.id }}" class="vm-title">
                                        <img :src="getImageLink(team.image, 'avatar_team')" class="img-responsive team-image w-40px" :alt="team.title" />
                                        <span class="ml-15">{{team.title}}</span>
                                    </router-link>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="mt-80">&nbsp;</div>
                                <div class="match">
                                    <router-link  :to="{ name: 'match', params: { id: 21}}" class="match-connector">
                                        август 29-го, 12:00 МСК
                                    </router-link>
                            ...
                            <div class="col-lg-3">
                                <div class="mt-80">&nbsp;</div>
                                <div class="match">
                                    <router-link  :to="{ name: 'match', params: { id: 22}}" class="match-connector">
                                        август 29-го, 15:00 МСК
                                    </router-link>
                                    <div v-for="team in tournament.teams" v-if="[146,110].includes(team.id)" class="team-bracket">
                                        <router-link  :to="{ name: 'team', params: { id: team.id }}" class="vm-title text-right">
                                            <span class="mr-15">{{team.title}}</span>
                                            <img :src="getImageLink(team.image, 'avatar_team')" class="img-responsive team-image w-40px" :alt="team.title" />
                                        </router-link>
                                    </div>
                                </div>
                        ...
                        <div class="row mt-30">
                            ...
                            <div class="col-lg-4 text-center">
                                <div class="match">
                                    <router-link  :to="{ name: 'match', params: { id: 23}}" class="match-connector">
                                        август 30-го, 12:00 МСК
                                    </router-link>
                            ...
                            <div class="col-lg-4 text-center">
                                <div class="match">
                                    <router-link  :to="{ name: 'match', params: { id: 24}}" class="match-connector">
                                        август 30-го, 15:00 МСК
                                    </router-link>
