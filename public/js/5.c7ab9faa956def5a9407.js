...
exports.default = {
    ...
    methods: {
        ...
        countClass: function countClass(bracket, type) {
            ...
            if (!type) {
                if (bracket.round.number == 1) result.push('d-block');else result.push('mt-55');
            }
        ...
        [
          ...
          _c(
            "ul",
            {
              ...
              class: _vm.countClass(bracket, _vm.brackets.type)
            },
