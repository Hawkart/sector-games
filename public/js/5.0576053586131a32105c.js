...
throw new Error("Module build failed: SyntaxError: C:/xampp/htdocs/sector.local/resources/assets/js/components/Brackets.vue: Unterminated string constant (108:19)\n\n  106 |             var result = [];\n  107 | \n> 108 |             d-block': (!brackets.type && bracket.round.number==1)\n      |                    ^\n  109 | \n  110 |             return result;\n  111 |         }\n");
