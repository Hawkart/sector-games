...
throw new Error("Module build failed: SyntaxError: C:/xampp/htdocs/sector.local/resources/assets/js/components/Brackets.vue: Unexpected token (113:38)\n\n  111 |                     result.push('d-block');\n  112 |                 else\n> 113 |                     result.push('mt-'+);\n      |                                       ^\n  114 |             }\n  115 | \n  116 |             return result;\n");
