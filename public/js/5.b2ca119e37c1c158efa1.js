...
throw new Error("Module build failed: SyntaxError: C:/xampp/htdocs/sector.local/resources/assets/js/components/Brackets.vue: Unterminated string constant (107:19)\n\n  105 |         {\n  106 |             \n> 107 |             d-block': (!brackets.type && bracket.round.number==1)\n      |                    ^\n  108 |         }\n  109 |     }\n  110 | }\n");
