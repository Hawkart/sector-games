...
exports.default = {
    ...
    methods: {
        getVueItems: function getVueItems() {
            ...
            if (parseInt(this.status_id) == 0 || parseIntthis.status_id == 1) queryStartParams['free_player'] = this.status_id;
