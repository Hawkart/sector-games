...
exports.default = {
    ...
    methods: {
        getVueItems: function getVueItems() {
            ...
            if (this.nickname.length > 0) var query = this.UrlParamsMerge(queryStartParams);
