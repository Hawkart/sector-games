...
exports.default = {
    ...
    methods: {
        getVueItems: function getVueItems() {
            ...
            if (this.nickname.length > 0) queryStartParams['q'] = this.nickname;
